...
namespace com.VR_Robotica.AvatarComponents
{
	...
	[System.Serializable]
	public class VRR_SimpleEyeGaze : MonoBehaviour
	{
		...
		[Range(0.01f, 0.1f)]
		public float BetweenFrameRate;
		[Range(0.01f, 1.0f)]
		public float EyeClosedPause;
		// if using a square atlas, define division of rows and columns
		[Range(1, 16)]
		public int SquareAtlasDivision;
		[Space]
		[Header("Gazing Properties: ")]
		public bool AddEyeJitter;
		[Header("Pivot Angle Rotation Limits")]
		public float EyeRotLimitUp;
		public float EyeRotLimitDown;
		public float EyeRotLimitOut;
		public float EyeRotLimitIn;
		[Header("Texture Offset Limits")]
		public float LimitUp;
		public float LimitDown;
		public float LimitOut;
		public float LimitIn;
		[Space]
